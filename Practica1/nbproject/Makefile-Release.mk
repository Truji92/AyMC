...
${OBJECTDIR}/Burbuja.o: Burbuja.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Burbuja.o Burbuja.cpp
...
${OBJECTDIR}/Insercion.o: Insercion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Insercion.o Insercion.cpp
...
${OBJECTDIR}/TestOrdenacion.o: TestOrdenacion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestOrdenacion.o TestOrdenacion.cpp
