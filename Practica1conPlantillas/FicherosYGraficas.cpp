...
template<class T>
TestOrdenacion<T>* FicherosYGraficas<T>::test = NULL;

template<class T>
void FicherosYGraficas<T>::dibujar(string archivo){
#ifdef __linux__
...
template<class T>
void FicherosYGraficas<T>::GenerarGrafica(Tiempos *t, int size, int metodo) {
    char res;
    do {
...
template<class T>
void FicherosYGraficas<T>::GenerarGrafica(Tiempos **t, int size, vector<int> metodos) {
    char res;
    do {
        cout << "Generar Grafica? (s/n): ";
        cin >>res;
...
template<class T>
void FicherosYGraficas<T>::GuardarEnArchivo(Tiempos **t, int size, vector<int> metodos) {
    char res;
    do {
...
template<class T>
void FicherosYGraficas<T>::GuardarEnArchivo(Tiempos *t, int size, int metodo) {
    char res;
    do {
        cout << "Guardar en fichero? (s/n): ";
        cin >>res;
